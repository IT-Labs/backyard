...
public class ItemsControllerTests extends BaseIntegration {
  ...
  void itemsGetTest() throws Exception {
    ...
    final var resultActions =
        mvc.perform(get(Routes.ITEMS_ROUTE).contentType(MediaType.APPLICATION_JSON))
            .andDo(print())
  ...
  void itemsPostEmptyBodyTest() throws Exception {
    final var resultActions =
        mvc.perform(post(Routes.ITEMS_ROUTE).content("").contentType(MediaType.APPLICATION_JSON))
            .andDo(print());
  ...
  void itemsDeleteWrongIdTest() throws Exception {
    ...
    final var resultActions =
        mvc.perform(
                delete(getEditUrl(UUID.randomUUID().toString()))
                    .contentType(MediaType.APPLICATION_JSON))
            .andDo(print());
