...
Feature: Home Page
    ...
    Scenario Outline: Verify menu items from Home page
        Then the result should be <isVisible>
    Examples: 
    | User | Link | isVisible |
    | admin | Home | yes |
    | admin | Admin | yes |
    | admin | About | yes |
    | admin | Hi Username | yes |
    | admin | Login | no |
    | admin | Logout | yes |
    | not logged in | Home | yes |
    | not logged in | Admin | no |
    | not logged in | About | yes |
    | not logged in | Hi Username | no |
    | not logged in | Login | yes |
    | not logged in | Logout | no |
